...
const LoginForm = ({
  ...
  const placeholderUser = intl.formatMessage({
    id: "login.username",
    defaultMessage: "Nombre de usuario",
  });
  const placeholderPass = intl.formatMessage({
    id: "login.password",
    defaultMessage: "Contraseña",
  });
  const placeholderEmail = intl.formatMessage({
    id: "modal.input.email",
    defaultMessage: "Digite su correo",
  });
  const placeholderId = intl.formatMessage({
    id: "modal.input.id",
    defaultMessage: "Digite su numero de identificacion",
  });
      ...
      <div className="container-login">
        <div className="d-flex justify-content-center">
          <p className="txt-title">
            <FormattedMessage id="login.title" defaultMessage="BIENVENIDO" />
          </p>
        </div>
        ...
        <div className="row container-input">
          <div className="d-flex justify-content-center mb-3">
            <p className="txt-subtitle">
              <FormattedMessage
                id="login.subtitle"
                defaultMessage="Sing in to your account"
              />
            </p>
          </div>
          ...
          >
            ...
            <div className="d-flex justify-content-center mt-1">
              <p className="txt-forgot" onClick={modalToggle}>
                {
                  <FormattedMessage
                    id="login.forgot"
